...
def find_sqli(data: str, strictness: SqliStrictness = SqliStrictness.STRICT, banned_characters=None) -> bool:
    score = 0
    ...
    if banned_characters is not None and len(banned_characters) > 0:
